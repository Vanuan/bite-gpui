...
use crate::{
    A11yCallbacks, Decorations, DispatchEventResult, ExternalDragPayload, GpuSpecs, PlatformDisplay,
    PlatformInput, PlatformInputHandler, PromptButton, PromptLevel, RequestFrameOptions, ResizeEdge,
    SystemWindowTab, TextInputConfiguration, TextInputStateChange, WindowAppearance,
    WindowBackgroundAppearance, WindowBounds, WindowControlArea, WindowControls, WindowDecorations,
    WindowInsets,
};
use futures::channel::oneshot;
use gpui_engine::{PlatformAtlas, Scene};
...
pub trait PlatformWindow: HasWindowHandle + HasDisplayHandle {
    ...
    #[cfg(any(test, feature = "test-support"))]
    fn render_to_image(&self, _scene: &Scene) -> anyhow::Result<RgbaImage> {

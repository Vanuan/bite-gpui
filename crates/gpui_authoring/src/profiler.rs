...
#[cfg(feature = "profiler")]
#[doc(hidden)]
pub fn get_all_timings(included: gpui_runtime::TasksIncluded) -> Vec<gpui_runtime::ThreadTaskTimings> {
    ThreadTaskTimings::collect(upgraded_thread_timings(), included)
}

#[cfg(feature = "profiler")]
#[doc(hidden)]
pub fn get_current_thread_timings(included: TasksIncluded) -> gpui_runtime::ThreadTaskTimings {
    gpui_runtime::profiler::get_current_thread_task_timings(included)
}

#[cfg(feature = "profiler")]
#[doc(hidden)]
pub fn take_all_stats(included: TasksIncluded) -> Vec<gpui_runtime::ThreadTaskStatistics> {
    ThreadTaskStatistics::collect_and_reset(upgraded_thread_timings(), included)
}

#[cfg(not(feature = "profiler"))]
#[doc(hidden)]
pub fn get_all_timings(_included: gpui_runtime::TasksIncluded) -> Vec<gpui_runtime::ThreadTaskTimings> {
    Vec::new()
}
#[cfg(not(feature = "profiler"))]
#[doc(hidden)]
pub fn get_current_thread_timings(_included: TasksIncluded) -> gpui_runtime::ThreadTaskTimings {
    gpui_runtime::ThreadTaskTimings {
        thread_name: None,
...
#[cfg(not(feature = "profiler"))]
#[doc(hidden)]
pub fn take_all_stats(_included: TasksIncluded) -> Vec<gpui_runtime::ThreadTaskStatistics> {
    Vec::new()
}

...
macro_rules! actions {
    ($namespace:path, [ $( $(#[$attr:meta])* $name:ident),* $(,)? ]) => {
        $(
            #[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug, gpui_runtime::Action)]
...
/// }
///
/// impl gpui_runtime::Action for Paste {
///     # fn boxed_clone(&self) -> Box<dyn gpui_runtime::Action> { unimplemented!()}
///     # fn partial_eq(&self, other: &dyn gpui_runtime::Action) -> bool { unimplemented!() }
///     # fn name(&self) -> &'static str { "Paste" }
///     # fn name_for_type() -> &'static str { "Paste" }
///     # fn build(value: serde_json::Value) -> anyhow::Result<Box<dyn gpui_runtime::Action>> {
///     #     unimplemented!()
///     # }
/// }
///

...
//! paints what it finds — the immediate-mode loop. Installing a different one is
//! how a window renders some other way without knowing about it; see the
    ...
    fn draw(&mut self, window: &mut Window, cx: &mut App) -> ArenaClearNeeded {
        ...
        if !cx.mode.skip_drawing() {
            ...
            #[cfg(feature = "profiler")]
            {
                ...
                window.debug_frame_overlay.paint(

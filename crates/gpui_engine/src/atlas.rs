//! Sprite-atlas vocabulary: the raster parameters that identify a cached tile, the
//! atlas tile/texture identifiers, and the atlas contract platform backends implement.

...
impl CosmicTextSystem {
    ...
    pub fn font_weight_and_style(
        &self,
        font_id: FontId,
    ) -> Result<(gpui_platform_core::FontWeight, gpui_platform_core::FontStyle)> {
        ...
        let style = match face.style {
            cosmic_text::Style::Normal => gpui_platform_core::FontStyle::Normal,
            cosmic_text::Style::Italic => gpui_platform_core::FontStyle::Italic,
            cosmic_text::Style::Oblique => gpui_platform_core::FontStyle::Oblique,
        };
        Ok((gpui_platform_core::FontWeight(face.weight.0 as f32), style))
    }

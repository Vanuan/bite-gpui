                ...
                if let Type::Path(ty) = &*arg.ty {
                    ...
                    match last_segment.map(|s| s.ident.to_string()).as_deref() {
                        ...
                        Some("BackgroundExecutor") => {
                            inner_fn_args.extend(quote!(gpui_platform::BackgroundExecutor::new(
            ...
            fn #outer_fn_name() {
                ...
                gpui_runtime::run_test(
                    ...
                    &mut |dispatcher, _seed| {
                        ...
                        #cx_vars
                        gpui_platform::ForegroundExecutor::new(exec.clone()).block_test(#inner_fn_name(#inner_fn_args));
                        drop(exec);
                        #cx_teardowns
